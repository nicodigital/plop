...
export const GET: APIRoute = async () => {
  ...
  const body = [
    ...
    `> ${SITE_DESCRIPTION}`,
    "",
    `${SITE_NAME} é um estúdio de desenvolvimento web em ${ADDRESS.city}, ${ADDRESS.region},`,
    "focado em negócios independentes, atendendo todo o Brasil. Cada plano entrega",
    "um site publicado mais um cuidado mensal — hospedagem, suporte técnico,",
    "manutenção e, nos planos com blog, uma publicação por mês. Os sites são HTML",
    "estático, sem painel para o cliente administrar. Conteúdo em português do",
    "Brasil; atendimento também em espanhol e inglês.",
    "",
    `Responsável: ${AUTHOR.name}, que faz sites há mais de ${AUTHOR.yearsBuilding} anos e já entregou`,
    `mais de ${AUTHOR.sitesBuilt}.`,
    "",
    "## Páginas",
    "",
